...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-black overflow-hidden">
      ...
      <section ref={heroRef} className="min-h-screen flex items-center justify-center relative overflow-hidden">
          ...
          <div className="w-[150vw] h-[150vw] max-w-[1400px] max-h-[1400px] bg-gradient-to-br from-yellow-400 via-yellow-500 to-orange-400 rounded-full flex items-center justify-center relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="relative w-80 h-80">
                <svg className="w-full h-full animate-spin-very-slow" viewBox="0 0 300 300">
                  <defs>
                    <path id="circle-text" d="M 150, 150 m -120, 0 a 120,120 0 1,1 240,0 a 120,120 0 1,1 -240,0" />
                  </defs>
                  <text className="text-sm font-bold fill-black tracking-[0.3em] uppercase">
                    <textPath href="#circle-text" startOffset="0%">
                      10SILICON • INNOVATION • CREATIVITY • TECHNOLOGY • DESIGN • EXCELLENCE • DIGITAL • SOLUTIONS • 
                    </textPath>
                  </text>
                </svg>
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-24 h-24 bg-black rounded-full flex items-center justify-center relative">
                    <span className="text-yellow-400 font-black text-3xl">10</span>
        ...
        <div className="absolute bottom-12 left-1/2 transform -translate-x-1/2 fade-in-element opacity-0 animation-delay-800">
          <div className="flex flex-col items-center text-white/60">
            <span className="text-sm font-medium mb-4 tracking-wider">EXPLORE</span>
        ...
        <div className="fixed bottom-8 right-8 z-20 fade-in-element opacity-0 animation-delay-1000">
          <Link href="/contact" className="w-16 h-16 bg-white rounded-full flex items-center justify-center hover:scale-110 transition-all duration-300 shadow-2xl group">
      ...
      {/* Services Section */}
      <section ref={servicesRef} className="py-32 bg-black relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-8 max-w-7xl relative z-10">
          <div className="fade-in-element opacity-0 mb-20">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-white/70 max-w-3xl mx-auto leading-relaxed">
                We create digital experiences that transform businesses and engage audiences
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 mb-20">
            ...
            <div className="fade-in-element opacity-0 animation-delay-400">
              <div className="group cursor-pointer h-96">
                <div className="relative bg-yellow-400 rounded-3xl p-10 h-full overflow-hidden hover:scale-105 transition-all duration-700 hover:-rotate-1">
                  <div className="absolute top-6 right-6 text-8xl font-black text-black/10">02</div>
            ...
            <div className="fade-in-element opacity-0 animation-delay-600">
              <div className="group cursor-pointer h-96">
                <div className="relative bg-white rounded-3xl p-10 h-full overflow-hidden hover:scale-105 transition-all duration-700 hover:rotate-1">
                  <div className="absolute top-6 right-6 text-8xl font-black text-yellow-400/20">03</div>
      ...
      <section ref={workRef} className="py-32 bg-black relative overflow-hidden">
              ...
              <div className="group cursor-pointer">
                <div className="relative bg-white rounded-3xl overflow-hidden hover:scale-105 transition-all duration-700 hover:rotate-1">
                  <div className="h-80 bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100 relative overflow-hidden">
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="w-32 h-32 bg-blue-600 rounded-3xl flex items-center justify-center group-hover:rotate-12 transition-transform duration-500 relative">
                    ...
                    <div className="absolute bottom-8 left-8 w-16 h-16 bg-purple-600 rounded-full opacity-40 group-hover:rotate-45 transition-transform duration-700"></div>
                    <div className="absolute top-6 left-6 text-6xl font-black text-black/5">01</div>
                  </div>
                  
                  <div className="p-10">
                    <span className="text-sm text-gray-500 uppercase tracking-widest font-bold mb-3 block">E-COMMERCE PLATFORM</span>
                    <h3 className="text-3xl font-black text-black mb-6 leading-tight">AI-POWERED SHOPPING EXPERIENCE</h3>
                    <p className="text-gray-600 mb-8 leading-relaxed text-lg">Next.js platform with intelligent recommendations and real-time inventory management system.</p>
                    
                    <div className="flex items-center justify-between">
                      <div className="flex space-x-4">
                        <span className="bg-gray-100 px-4 py-2 rounded-full text-sm font-bold">+35% CONVERSION</span>
                        <span className="bg-gray-100 px-4 py-2 rounded-full text-sm font-bold">2.1S LOAD</span>
                      </div>
              ...
              <div className="group cursor-pointer">
                <div className="relative bg-yellow-400 rounded-3xl overflow-hidden hover:scale-105 transition-all duration-700 hover:-rotate-1">
                  <div className="h-80 bg-gradient-to-br from-yellow-300 via-orange-300 to-red-300 relative overflow-hidden">
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="w-32 h-32 bg-black rounded-3xl flex items-center justify-center group-hover:rotate-12 transition-transform duration-500 relative">
                    ...
                    <div className="absolute top-8 right-8 w-20 h-20 bg-black/20 rounded-full group-hover:scale-150 transition-transform duration-700"></div>
                    <div className="absolute bottom-8 left-8 w-16 h-16 bg-black/10 rounded-full group-hover:rotate-45 transition-transform duration-700"></div>
                    <div className="absolute top-6 left-6 text-6xl font-black text-black/10">02</div>
                  </div>
                  
                  <div className="p-10">
                    <span className="text-sm text-black/60 uppercase tracking-widest font-bold mb-3 block">HEALTHCARE PLATFORM</span>
                    <h3 className="text-3xl font-black text-black mb-6 leading-tight">DIGITAL HEALTH MANAGEMENT</h3>
                    <p className="text-black/80 mb-8 leading-relaxed text-lg">Comprehensive platform with telemedicine capabilities and patient management system.</p>
                    
                    <div className="flex items-center justify-between">
                      <div className="flex space-x-4">
                        <span className="bg-black/10 px-4 py-2 rounded-full text-sm font-bold text-black">95% SATISFACTION</span>
                        <span className="bg-black/10 px-4 py-2 rounded-full text-sm font-bold text-black">+50% EFFICIENCY</span>
                      </div>
        ...
        <div className="absolute left-0 top-1/2 transform -translate-x-1/3 -translate-y-1/2">
          <div className="w-[80vw] h-[80vw] max-w-[800px] max-h-[800px] bg-yellow-400 rounded-full flex items-center justify-center">
            <div className="text-center">
              ...
              <h3 className="text-4xl font-black text-black mb-4">LET'S CREATE</h3>
              <p className="text-black/80 font-bold text-lg">SOMETHING AMAZING</p>
            </div>
          </div>
        </div>
          ...
          <div className="ml-auto max-w-2xl">
            ...
            <div className="fade-in-element opacity-0 animation-delay-200">
              <p className="text-xl text-white/70 mb-12 leading-relaxed">
                Ready to transform your digital presence? Let's discuss how we can help bring your vision to life with cutting-edge technology.
              </p>
            </div>
